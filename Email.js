...
const ETemplate = ["name","Email","mobile number","Address","Date","Time","....other props"];
    ...
    <View style={[styles.container, containerStyle]}>
      ...
      <View style={styles.emailRow}>
        <View style={styles.emailColumn}>
          <Text style={styles.emailText}>{Esubject} : {ETemplate}</Text>
        </View>
...
const Esubject = "index->(ની જરૂર છે.)"
Email.defaultProps = {
  containerStyle: {},
  name: null,
}
