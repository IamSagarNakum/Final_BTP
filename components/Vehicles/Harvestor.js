...
const crop = ["મગફળી(Peanuts)","તલ(Sesame)","કપાસ(Cotton)","ઘઉં(Wheat)","તુવેર(Tuwer)","એરંડા(Castor)","મગ(Mung)","ચણા(Chickpeas)"];
...
export default function Labours() {
   <Text style={styles.Header} >હાર્વેસ્ટર  ભાડે કયો   </Text>;

   <Text>નીચેના ખાનામાં વિગતો ભરો અને ઓર્ડર બટન દબાવો હાર્વેસ્ટર ભાડે લેવા માટે </Text>;
   ...
   <FlatList>ક્યા પાક માટે ?  {crop} </FlatList>;
   <Location></Location>;
