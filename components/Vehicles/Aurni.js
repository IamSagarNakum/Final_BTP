...
const crop = ["મગફળી(Peanuts)",".ધાણા(Coriander)","મેથી(Fenugreek)","જીરું(Cumin)","મગ(Mung)","ચણા(Chickpeas)","જુવાર(Sorghum)","મકાઈ(Maize)"];
...
export default function Labours() {
   <Text style={styles.Header} >ઑટોમૅટિક ઓરણી ભાડે કયો  </Text>;

   <Text>નીચેના ખાનામાં વિગતો ભરો અને ઓર્ડર બટન દબાવો ઑટોમૅટિક ઓરણી ભાડે લેવા માટે </Text>;
