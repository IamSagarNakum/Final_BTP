...
const crop = ["તલ(Sesame)","ઘઉં(Wheat)","જુવાર(Sorghum)","મકાઈ(Maize)","બાજરી(Millet)","ચોખા(Rice)"];
...
export default function Labours() {
   <Text style={styles.Header} >પાક વાઢવાનુ મશીન ભાડે કયો   </Text>;

   <Text>નીચેના ખાનામાં વિગતો ભરો અને ઓર્ડર બટન દબાવો પાક વાઢવાનુ મશીન ભાડે લેવા માટે </Text>;
