...
const crop = ["તલ(Sesame)","ધાણા(Coriander)","ઘઉં(Wheat)","મેથી(Fenugreek)","જીરું(Cumin)","મગ(Mung)","ચણા(Chickpeas)","બાજરી(Millet)"];
...
export default function Labours() {
   <Text style={styles.Header} >ફૂંકણી ભાડે કયો   </Text>;

   <Text>નીચેના ખાનામાં વિગતો ભરો અને ઓર્ડર બટન દબાવો ફૂંકણી ભાડે લેવા માટે </Text>;
